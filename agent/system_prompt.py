...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Pocura never re-renders parts of this string mid-
    ...
    # Pointer to the hermes-agent skill + docs for user questions about Pocura itself.
    ...
    # Coding posture (base Pocura, any interactive coding surface in a code
    ...
    # Active-profile hint — names the Pocura profile the agent is running
    ...
    if active_profile == "default":
        stable_parts.append(
            "Active Pocura profile: default. Other profiles (if any) live "
        ...
        stable_parts.append(
            f"Active Pocura profile: {active_profile}. This session reads "
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Pocura never rebuilds or reinjects parts of it
