...
export const en: Translations = {
  ...
  boot: {
    ready: 'Pocura Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Pocura settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Pocura Desktop…'
    },
    errors: {
      backgroundExited: 'Pocura background process exited.',
      backgroundExitedDuringStartup: 'Pocura background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Pocura backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Pocura',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Pocura Desktop.',
    ...
    native: {
      ...
      inputBody: 'Pocura is waiting for your response.',
      turnDoneTitle: 'Pocura finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Pocura defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Pocura is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Pocura asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Pocura was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Pocura follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Pocura is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Pocura, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Pocura checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Pocura configuration...',
    ...
    gateway: {
      ...
      intro:
        'Pocura Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Pocura backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Pocura backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Pocura backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Pocura Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Pocura ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Pocura runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  starmap: {
    ...
    emptyDesc: 'As Pocura builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Pocura to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Pocura to generate pets.',
      backgroundHint: 'You can close this — Pocura will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Pocura desktop' },
    ...
    hermesActiveSessions: (version, count) => `Pocura ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Pocura environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Pocura will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Pocura backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Pocura. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Pocura...',
    placeholderReconnecting: 'Reconnecting to Pocura…',
    ...
    attachUrlDesc: 'Pocura will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Pocura to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Pocura…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Pocura…',
    ...
    unsupportedMessage: 'This version of Pocura can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Pocura is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Pocura backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Pocura from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Pocura will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Pocura desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Pocura updater takes over in its own window and reopens Pocura automatically when it’s done. Please don’t reopen Pocura yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Pocura reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Pocura reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Pocura needs a one-time install',
    ...
    settingUpTitle: 'Setting up Pocura Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Pocura CLI or desktop instance is running. Stop any running Pocura instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    ...
    preparingInstall: 'Pocura is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Pocura…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Pocura',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Pocura at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Pocura connects automatically',
    ...
    authorizeThere: 'Authorize Pocura there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Pocura there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Pocura Desktop v${version}`,
      ...
      gatewayTitle: 'Pocura inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Pocura will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Pocura is restarting...',
      askRestart: 'Ask Pocura to restart the server',
      lookingRestart: taskId => `Pocura is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Pocura is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Pocura finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Pocura could not restart the server.',
      stillWorking:
        'Pocura is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Pocura is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Pocura gateway is not connected',
  ...
  prompts: {
    ...
    sudoDesc: 'Pocura needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Pocura needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Pocura Desktop to use Save Image.',
    restartToSaveImages: 'Restart Pocura Desktop to save images',
