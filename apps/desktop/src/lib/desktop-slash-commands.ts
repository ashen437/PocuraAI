...
/** Why a known Pocura command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Pocura profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show Pocura Agent version', surface: exec() },
 ...
 * Pocura' built-in slash commands — i.e. skill commands (`/gif-search`,
