...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Pocura' : 'Setting up Pocura Agent'
  const description = isUpdate
    ? 'Pocura is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Pocura installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
